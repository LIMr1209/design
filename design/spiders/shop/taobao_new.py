...
class TaobaoSpider(SeleniumSpider):
    ...
    def start_requests(self):
        ...
        # 爬取失败重新爬取
        # list_url = ['https://item.taobao.com/item.htm?id=632294750696&ns=1&abbucket=14#detail', 'https://item.taobao.com/item.htm?id=628283099006&ns=1&abbucket=14#detail']
        # self.category = '茶具'
        # self.error_retry = 1
