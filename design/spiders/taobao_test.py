...
class TaobaoSpider(SeleniumSpider):
    ...
    def start_requests(self):
        # self.update_cookie()
        # self.stringToDict()
        list_url = ['https://detail.tmall.com/item.htm?id=632845138580',
 'https://detail.tmall.com/item.htm?id=630084224925',
 'https://detail.tmall.com/item.htm?id=632516327460',
 'https://detail.tmall.com/item.htm?id=612286314810',
 'https://detail.tmall.com/item.htm?id=628265689994']
        if list_url:
